<div class="payment_module {if $smartcoin_ps_version < '1.5'}smartcoin-payment-15{/if}{if $smartcoin_ps_version > '1.5'}smartcoin-payment-16{/if}">
	...
	<div id="smartcoin_bank_slip_box" class="smartcoin_bank_slip_box">
	...
	<div>
		<div  style="float: left;">
			<input type="radio" id="smartcoin_payment_option_cc" name="smartcoin_payment_option" value="credit_card" checked >
		</div>
		<h3 class="smartcoin_title">{l s='Pay by credit card' mod='smartcoin'} <img alt="" src="{$module_dir|escape:htmlall:'UTF-8'}img/secure-icon.png" /></h3>
	</div>
	<div id="smartcoin_cc_box" class="smartcoin_cc_box" >
